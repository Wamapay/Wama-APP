  ...
  return (
    <div className="space-y-5 fade-in">
      ...
      <div className="card p-4 sm:p-5 space-y-4">
        ...
        <Field label="Course Thumbnail" hint="Upload an image from your device, or paste a URL directly.">
      ...
      <div className="card p-4 sm:p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Field label="Platform Name">
            <input value={form.platformName} onChange={set("platformName")} placeholder="e.g. Learn & Earn" className={inputClass} style={inputStyle} />
          </Field>
