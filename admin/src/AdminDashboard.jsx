    ...
    <div className="space-y-4 fade-in">
      ...
      <div className="card p-4 sm:p-5 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Field label="Logo URL" hint="A link to an already-hosted image — this doesn't upload a file.">
            <input value={form.logoUrl} onChange={set("logoUrl")} placeholder="https://..." className={inputClass} style={inputStyle} />
          </Field>
          <Field label="Tagline">
