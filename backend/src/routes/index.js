...
router.use("/community/chat", require("./communityChat.routes"));
router.use("/billboard", require("./billboard.routes"));
...
// Real, user-facing notification endpoints (admin-sent — see admin.routes.js).
