...
/** @route GET /api/v1/orders/recent-activity @desc Real recent platform-wide purchases, privacy-safe (first name + last initial only) @access Private */
router.get("/recent-activity", orderController.listRecentActivity);
