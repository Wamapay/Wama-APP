...
const createWithdrawalSchema = z.object({
  body: z.object({
    ...
    // Real 4-digit format check happens here; whether it's the RIGHT
    // pin (and the real brute-force lockout) is checked in
    // withdrawalPin.service.js — never trust format validation alone
